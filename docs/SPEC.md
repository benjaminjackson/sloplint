...
- `mic-drop-closer` — a sentence of 60+ characters, then a paragraph-final closer of two to eight words opening on a quantifier or deictic (Nothing, Most, None, Everything, Then, That, This, It…): "Nothing here needs a new login."; `info`. The note points at the closer. One means nothing; a draft where it repeats is the tell.
