...
| `thats-the-whole` | "that/this is the whole point/game/thing…" | also value, fix, trick, bet, job, the closers agents write in technical prose; `is-the-whole-x` yields the same list |
