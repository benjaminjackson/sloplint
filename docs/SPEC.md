...
| `is-the-whole-x` | any subject + "is the whole/real/actual N" (tell, point, test, work, …) | "that/this" subjects left to `thats-the-whole`, "entire" to `is-the-entire`, "only" left out; `info` |
