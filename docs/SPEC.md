...
- `np-fragment-and` — a whole sentence made of two noun phrases and an "and", opening on A/An/One at a sentence start ("A named owner and a quarterly review."). One to three words a side, no auxiliary or modal anywhere; a lexical verb can slip through.
